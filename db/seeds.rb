...
user4 = User.create(email:" vincent@gmail.com",password: "123456", first_name: "Vincent", last_name:"Crenin", age: 22, description: "Bonjour, disposant souvent d'objet encombrant, je suis a la recherche d'une personne pouvant deplacer mes objets frequemment", transporter: false )
