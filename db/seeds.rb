...
# user2 = User.create(email:" adrien@gmail.com",password: "123456", first_name: "adrien", last_name:"Z", age: 22, description: "Bonjour, transporter d'objet encombant depuis des années je disposes d'un camion pouvant sockter vos objets les plus imposant", transporter: true )
...
# transporter2 = Transporter.create!(car: "Camion", capacity: "grande", permit: "123410345123", cin: "123331234123", user_id: adam)


product1 = Product.create(description: "Grand canapé, dimension : 192*150cm, etc .......", title: "Canapé", status: 0,user_id: 1 )
product1 = Product.create(description: "Grande armoire, dimension : 400*150cm, etc .......", title: "Armoire", status: 0,user_id: 1 )
